		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				<div class="col-xs-12 col-sm-4 col-md-4">
					...
					<ul class="list-unstyled quick-links">
						...
						<li><a href="faqs.php"><i class="fa fa-angle-double-right"></i>FAQ</a></li>
						<li><a href="signup.php"><i class="fa fa-angle-double-right"></i>Get Started</a></li>
					</ul>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4">
				</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
					...
					<p class="h6">&copy All right Reversed.<a class="text-green ml-2" target="_blank">awans</a></p>
				</div>
				</hr>
			</div>	
		</div>
