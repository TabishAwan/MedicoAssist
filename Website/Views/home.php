  ...
  <body class="sbar_color_one">
    ...
    <section class="main-slider">
      <div class="main-slider-carousel main-slider-one owl-carousel owl-theme">
         <div class="slide" style="background-image:url(http://steelthemes.com/demo/Elango/meditex-final/assets/image/banner/home-1-banner-1.jpg)">
            <div class="container text-left">
               <div class="content ">
                   ...
                   <div class="link-box">
                        <a href="Labs.php" class="theme-btn ">LABORATORIES</a>
                        <a href="contact.php" class="theme-btn btn-dark">Get in Touch</a>
                   </div>
               </div>
           </div>
         </div>
         <div class="slide" style="background-image:url(http://steelthemes.com/demo/Elango/meditex-final/assets/image/banner/home-1-banner-2.jpg)">
            <div class="container text-left">
                  <div class="content ">
         ...
         <div class="slide" style="background-image:url(http://steelthemes.com/demo/Elango/meditex-final/assets/image/banner/home-1-banner-3.jpg)">
            <div class="container text-left">
                  <div class="content ">
            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div  >
							<img src="../Assets/img/banner-homepage.jpg" >
						</div>
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                      ...
                                      onclick="window.location.replace('time-table.php');">BOOK YOUR APPOINTMENT NOW</button>
                                    </div>
                                 </div>
...
<section class="department_section hm-one">
      <div class="container">
          <div class="row">
            <div class="col-lg-12">
                <div  class="heading clearfix">
                  <h1>OUR <span>Laboratories</span></h1>
                </div>
            </div>
          </div>
          <div class="department_inner">
            <div class="row">
              <div class="col-lg-12" id="labDiv">
          ...
          <div class="view-more-doctors">
             <a href="Labs.php" class="view-doctors">SEE ALL LABORATORIES</a>
          </div>
      </div>
   </section>
<!-------department-section----->
...
<!---------welcomen-sec--------->
<section class="welcome_section hme-one" style="background:url(http://steelthemes.com/demo/Elango/meditex-final/assets/image/welcome-hme-1-bg.jpg)">
   <div class="container">
      ...
      <div  class="row">
         <div class="col-lg-6">
            <div class="welcme_inner">
               ...
               <ul>
                  <li><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/awards-1.png" class="img-fluid" alt="awards" /></li>
                  <li><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/awards-2.png" class="img-fluid" alt="awards" /></li>
                  <li><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/awards-3.png" class="img-fluid" alt="awards" /></li>
                  <li><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/awards-4.png" class="img-fluid" alt="awards" /></li>
               </ul>
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <div class="mak_appointment">
               <a onclick="window.location.replace('time-table.php');">MAKE AN APPOINTMENT</a>
            </div>
         </div>
      </div>
   </div>
...
<section class="testimonial_sec hm-one">
      <div class="container">
            ...
            <div class="owl-carousel owl-theme client-carousel">
             ...
             <div class="item"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/client/client-hm-1.jpg" class="img-fluid" alt="img" /></div>
             <div class="item"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/client/client-hm-2.jpg" class="img-fluid" alt="img" /></div>
             <div class="item"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/client/client-hm-3.jpg" class="img-fluid" alt="img" /></div>
             <div class="item"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/client/client-hm-4.jpg" class="img-fluid" alt="img" /></div>
             <div class="item"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/client/client-hm-5.jpg" class="img-fluid" alt="img" /></div>
...
<section class="department_section hm-one">
      <div class="container">
          ...
          <div class="department_inner">
            <div class="row">
              <div class="col-lg-12" id="doctorDiv">
                <div class="department_icon_content">
                  <a href="#"><img src=""></a>
                  <a href="#"> <h2>Psychiatry</h2></a>
                  <p>In its ongoing attempts to define, understand, and categorize disorders...</p>
          ...
          <div class="view-more-doctors">
             <a href="our-doctors.php" class="view-doctors">SEE ALL DOCTORS</a>
          </div>
      </div>
   </section>
                  ...
                  <div class="col-lg-6">
                     ...
                     <div class="articles-outer">
                        <div class="articles-inner">
                           <a href="faqs.php"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/articles/articles-3-3.jpg" class="img-fluid" alt="articles"></a>
                           <div class="articles-content">
                              <p>Business  .   July 10, 2018</a></p>
                              <h2><a href="faqs.php">Thousands of Patients Referred to Substance Use Treatment</a></h2>
                           </div>
                        </div>
                        <div class="articles-inner">
                           <a href="faqs.php"><img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/articles/articles-3-2.jpg" class="img-fluid" alt="articles"></a>
                           <div class="articles-content" >
                              <p>Lifestyle  .  <a href="faqs.php">  April 04, 2018</a></p>
                              <h2><a href="faqs.php">MedStar Health Bel Air Cancer Services Aligns Expertise</a></h2>
                           </div>
                        </div>
                        <div class="articles-inner">
                           <a href="faqs.php"> <img src="http://steelthemes.com/demo/Elango/meditex-final/assets/image/articles/articles-3-1.jpg" class="img-fluid" alt="articles"></a>
                           <div class="articles-content" a href="faqs.php">
                              <p>Experience  .   <a href="faqs.php"> February 20, 2018 </a></p>
                              <h2><a href="faqs.php">Dr. Gabriel Del Corral Joins MedStar Plastic & Reconstructive Surgery</a></h2>
                           </div>
                        </div>
         ...
         <div class="container-fluid">
            ...
            <div class="map-outer">
               <div class="google-map"
                  ...
                  data-icon-path="http://steelthemes.com/demo/Elango/meditex-final/assets/image/icons/map-marker.png"
...
<div class="contact_through">
 ...
 <a href="#" id="scroll" class="default-bg" style="display: none;"><span></span></a>
  <!-------backtotop-------->
      ...
      <script src="http://steelthemes.com/demo/Elango/meditex-final/assets/js/appear.js"></script>  
