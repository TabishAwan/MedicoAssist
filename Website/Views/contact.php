...
<!-- Mirrored from steelthemes.com/demo/Elango/meditex-final/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Oct 2019 11:16:43 GMT -->
      ...
      <div class="row">
         <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="contact_address_inner">
               ...
               <div class="contact_get_in_touch">
                  ...
                  <div class="mail">
                  <p>EMAIL<br/>
                  <a href="mailto:contact@meditex.com">contact@meditex.com</a></p>
               </div>
                  <div class="phone">
                     <p>Phone number<br/>
                        <a href="#" class="phne">(052) 611-5711</a> </p>
                  </div>
               </div>
         ...
         <div class="col-lg-8 col-md-8 col-sm-12">
            <div class="contact_pg_form">
                  <form id="contact-form" method="post" action="http://steelthemes.com/demo/Elango/meditex-final/contact.php" role="form">
...
<!-------contact-through----->
<div class="contact_through type_one">
   <div class="container">
      <div class="row">
