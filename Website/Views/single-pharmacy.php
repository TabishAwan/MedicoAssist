...
<section class="ban-bread-crumb">
        <div class="container">
           ...
           <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item active" aria-current="page">Single-Pharmacy</li>
           </ol>
     </nav>
              </div>
           </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
              <div class="single_doctor_right">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="heading mg_btm" id="pharmacyName">
                      <h1> <span>Genova Leannon</span></h1>
                      <p>Dentist</p>
                    </div>
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="single_doc_banner" id="pharmacyImage">
                ...
                <div class="single_doctor_content" id="pharmacyDetails">
