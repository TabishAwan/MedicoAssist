          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
              <div class="single_doctor_right">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="heading mg_btm" id="docName">
                      <h1>Dr <span>Genova Leannon</span></h1>
                      <p>Dentist</p>
                    </div>
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="single_doc_banner" id="docImage">
                ...
                <div class="single_doctor_content" id="docDetails">
