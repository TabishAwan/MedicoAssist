...
<html>
	...
	<body>
                    	...
                    	<div class="col-md-12">
                      		<div class="card">
                    			<div class="card-header card-header-info card-header-icon">
                      				...
                      				<h4 class="card-title">Branches Of Labs List</h4>
                    			</div>
		                        <div class="card-body">
		                          <div class="toolbar">
		                          <div class="material-datatables">
		                            <div class="table-responsive">
		                              <table width="100%" class="table table-striped table-no-bordered table-hover dataTable dtr-inline"  role="grid" aria-describedby="datatables_info" style="width: 100%;" cellspacing="0" id="branchesofLabsTable">
	                                        <thead>
		...
		<div class="modal" id="editModalLabBranches">
					 ...
					 <div class="bs-example">
					    <form action="/examples/actions/confirmation.php" method="post">
					    	<div class="form-group">
					         	<input type="hidden" id="eLabKey">
					         	<input type="hidden" id="eBranchKey">
				...
				<div class="modal-footer">
					<button onclick="saveChangesLabBranches();" class="btn btn-primary" data-dismiss="modal">Save</button>
